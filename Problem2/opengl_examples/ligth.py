...
def main():
    ...
    if not glfw.init():
        return
    # Define version and compatibility ettings
    ...
    obj = ObjLoader()
    obj.load_model(os.path.join(os.getcwd(),"Problem2/opengl_examples/res/cube.obj"))

    texture_offset = len(obj.vertex_index)*12
    normal_offset = (texture_offset + len(obj.texture_index)*8)

    shader = compile_shader(os.path.join(os.getcwd(),"Problem2/opengl_examples/shaders/video_18_vert.vs"), os.path.join(os.getcwd(),"Problem2/opengl_examples/shaders/video_18_frag.fs"))
    ...
    # load image
    image = Image.open(os.path.join(os.getcwd(),"Problem2/opengl_examples/res/cube_texture.jpg"))
